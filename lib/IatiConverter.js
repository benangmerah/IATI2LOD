...
// Different from Brandt: added ability to supply graph to add to
ConvertActivity.prototype.convert = function(namespace, graph) {
  var self = this;
  ...
  var converter = new IatiElements.ActivityElements(defaults, graph);
